      ...
      <div class="col-xl-6 order-xl-2 order-1">
        <div class="rooms_right_content">
          ...
          <div class="rooms_text">
            <p>Luxury Double Suite Rooms offer space and comfort with thoughtful contemporary design and local Sri Lankan touches. All rooms offer exceptional views over the Beira Lake and the city beyond.</p>
          </div>
          <div class="rooms_list">
            <ul>
              <li class="d-flex flex-row align-items-center justify-content-start">
                <img src="images/check.png" alt="">
                <span>Each room offers 42 sqm / 452 sqf of luxury.</span>
              </li>
              <li class="d-flex flex-row align-items-center justify-content-start">
                <img src="images/check.png" alt="">
                <span>Large, modern bathroom with walk-in shower and separate bathtub.</span>
              </li>
              <li class="d-flex flex-row align-items-center justify-content-start">
                <img src="images/check.png" alt="">
                <span>Wi-Fi.</span>
    ...
    <div class="row row-eq-height">
      ...
      <div class="col-xl-6">
        <div class="rooms_left_content">
          ...
          <div class="rooms_text">
            <p>Luxury Single Rooms offers all feature a spacious balcony that offers views of the city and Beira Lake. The rooms are elegantly appointed and feature a thoughtful contemporary design, light colours, rich fabrics, and balconies with cosy outdoor seating.</p>
          </div>
          <div class="rooms_list">
            <ul>
              <li class="d-flex flex-row align-items-center justify-content-start">
              ...
              <li class="d-flex flex-row align-items-center justify-content-start">
                <img src="images/check.png" alt="">
                <span>Bed with 300 thread count lightweight duvet.</span>
              </li>
            </ul>
          </div>
      ...
      <div class="row discover_row">
        <div class="col-lg-5">
          <div class="discover_highlight">
            <p>As we understand how important connectivity, efficiency and comfort are to our business travellers, we have designed a set of benefits to help your company’s associates achieve their business goals wherever travel may take them.</p>
          </div>
          <!-- <div class="button discover_button"><a href="#">discover</a></div> -->
        </div>
        <div class="col-lg-7">
          <div class="discover_text">
            <p>Our Asian heritage places us in a unique position to understand and meet the special needs and expectations of multigenerational families. With Fam.ily, we hope to serve them better by providing opportunities to create memorable experiences as they explore, bond, and grow as a family. Beyond hospitality, Fam.ily also works with experts to support our customers on their parenting journeys.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="owl-carousel owl-theme testimonials_slider">
            ...
            <div>
              ...
              <div class="testimonial_author text-center">
                ...
                <div class="testimonial_author_name"><a href="#">Mr.Osada,</a><span> Frontend Developer</span></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="testimonial_author text-center">
                ...
                <div class="testimonial_author_name"><a href="#">Mr.Nadun Tilan,</a><span> Backend Developer</span></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="testimonial_author text-center">
                ...
                <div class="testimonial_author_name"><a href="#">Mr.Dulaj Ranathunge,</a><span> Frontend Developer</span></div>
              </div>
            </div>
